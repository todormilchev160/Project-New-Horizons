...
public class ScoreManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (keyboardscore >= pickupsToUnlockSoundtrack12)
        {
            soundtrack.setParameterByName("Timing", 12);
        }
        else if (keyboardscore >= pickupsToUnlockSoundtrack11)
        {
            soundtrack.setParameterByName("Timing", 11);
        }
        else if (keyboardscore >= pickupsToUnlockSoundtrack10)
        {
            soundtrack.setParameterByName("Timing", 10);
        }
        else if (keyboardscore >= pickupsToUnlockSoundtrack9)
        {
            soundtrack.setParameterByName("Timing", 9);
        }

        else if (guitarscore == pickupsToUnlockSoundtrack8)
        {
            soundtrack.setParameterByName("Timing", 8);
        }
        else if (guitarscore == pickupsToUnclockSoundtrack7)
        {
            soundtrack.setParameterByName("Timing", 7);
        }
        else if (guitarscore == pickupsToUnlockSoundtrack6)
        {
            soundtrack.setParameterByName("Timing", 6);
        }
        else if (guitarscore == pickupsToUnlockSoundtrack5)
        {
            soundtrack.setParameterByName("Timing", 5);
        }
        else if (drumscore == pickupsToUnlockSoundtrack4)
        {
            soundtrack.setParameterByName("Timing", 4);
        }
        else if (drumscore == pickupsToUnlockSoundtrack3)
        {
            soundtrack.setParameterByName("Timing", 3);
        }
        else if (drumscore == pickupsToUnclockSoundtrack2)
        {
            soundtrack.setParameterByName("Timing", 2);
        }
        else if (drumscore == pickupsToUnlockSoundtrack1)
        {
    ...
    public void AddDrumScore(int amount)
    {
        ...
        if (drumscore == pickupsToUnclockSoundtrack2)
        {
            soundtrack.setParameterByName("Timing", 2);
        }
        if (drumscore == pickupsToUnlockSoundtrack3)
        {
            soundtrack.setParameterByName("Timing", 3);
        }
        if (drumscore == pickupsToUnlockSoundtrack4)
        {
            soundtrack.setParameterByName("Timing", 4);
        }
    ...
    public void AddGuitarScore(int amount)
    {
        guitarscore += amount;
        UpdateGuitarScore();
        if (guitarscore == pickupsToUnlockSoundtrack5)
        {
            soundtrack.setParameterByName("Timing", 5);
        }
        if (guitarscore == pickupsToUnlockSoundtrack6)
        {
            soundtrack.setParameterByName("Timing", 6);
        }
        if (guitarscore == pickupsToUnclockSoundtrack7)
        {
            soundtrack.setParameterByName("Timing", 7);
        }
        if (guitarscore == pickupsToUnlockSoundtrack8)
        {
            soundtrack.setParameterByName("Timing", 8);
        }
    }
    public void AddKeyboardScore(int amount)
    {
        ...
        UpdateKeyboardScore();
        if (keyboardscore == pickupsToUnlockSoundtrack9)
        {
            soundtrack.setParameterByName("Timing", 9);
        }
        if (keyboardscore == pickupsToUnlockSoundtrack10)
        {
            soundtrack.setParameterByName("Timing", 10);
        }
        if (keyboardscore == pickupsToUnlockSoundtrack11)
        {
            soundtrack.setParameterByName("Timing", 11);
        }
        if (keyboardscore == pickupsToUnlockSoundtrack12)
